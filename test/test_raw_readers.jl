...
@testset "Raw Readers Tests (Minimal)" begin
    ...
    @testset "stream_chunks with raw text" begin
        ...
        chunks = collect(KeemenaPreprocessing.stream_chunks("Hello world test"))
    ...
    @testset "stream_chunks with multiple raw texts" begin
        chunks = collect(KeemenaPreprocessing.stream_chunks(["Text 1", "Text 2"]))
    ...
    @testset "stream_chunks line ending normalization" begin
        chunks = collect(KeemenaPreprocessing.stream_chunks("Line1\r\nLine2\rLine3"))
